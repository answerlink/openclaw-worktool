...
echo ""
echo "=============================================="
echo "  OpenClaw + WorkTool Plugin - Docker Setup (latest)"
echo "=============================================="
echo ""
...
prompt_value OPENCLAW_IMAGE  "OpenClaw image"       "alpine/openclaw:latest"
...
# SDK shim not needed: /app/dist/extensions/node_modules/openclaw already exists in latest image
STEP=$((STEP+1))
